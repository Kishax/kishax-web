      ...
      if (autoStart && processorRef.current) {
        ...
        processorRef.current.registerHandler(
          ...
          async (message) => {
            ...
            window.dispatchEvent(
              new CustomEvent("mcPlayerStatus", {
                detail: message.data,
              }),
            );
          },
